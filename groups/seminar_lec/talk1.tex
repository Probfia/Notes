...
对称性越大的理论，往往越“对”：
\begin{itemize}
\item 牛顿力学：三维旋转对称性 $\Rightarrow$ 相对论：时空（3+1）维对称性。
\par
群论语言：$SO(3) \to SO(3,1)$
...
\item 凝聚态物理学：晶体结构带来的离散对称性$\Rightarrow$对波函数的约束，例如Bloch定理。石墨烯：$D_6$对称性。
\end{itemize}
...
例如一个群总和自己的某个子群同态。
\par
若$f$是双射（单且满），则称$G$和$H$同构。例如$SO(2) \simeq U(1)$。
\par
